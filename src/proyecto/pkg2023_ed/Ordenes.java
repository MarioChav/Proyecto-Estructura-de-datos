...
public class Ordenes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Debes asumir el rol de gerente de una fábrica de autos. ");

        jLabel3.setText("El objetivo es crear la mayor cantidad de autos emblemáticos en un periodo de 8 minutos para cumplir con la demanda y mantener la reputación de la empresa.");
